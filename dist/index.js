...
function ChatInterface({
  ...
  if (isInitializing) {
    return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", paddingX: 2, paddingY: 1, children: [
      ...
      /* @__PURE__ */ jsx(Text, { color: "gray", children: "Please wait while we set up the agent..." })
    ] });
  }
  if (apiKeyError) {
    return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", paddingX: 2, paddingY: 1, children: [
      /* @__PURE__ */ jsx(Text, { color: "red", bold: true, children: "\u274C Agent Initialization Failed" }),
      /* @__PURE__ */ jsx(Text, { color: "yellow", children: apiKeyError }),
      /* @__PURE__ */ jsx(ApiKeyInput, { onApiKeySet: () => setApiKeyError(null) })
    ] });
  }
  if (!agent) {
    return /* @__PURE__ */ jsxs(Box, { flexDirection: "column", paddingX: 2, paddingY: 1, children: [
      /* @__PURE__ */ jsx(Text, { color: "yellow", bold: true, children: "\u26A0\uFE0F No Agent Available" }),
      /* @__PURE__ */ jsx(Text, { color: "gray", children: "Please provide an agent instance or ensure proper initialization." })
    ] });
  }
